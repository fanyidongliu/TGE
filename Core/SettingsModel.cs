...
namespace SqlSugar.Tools.Model
{
    ...
    internal class SettingsModel
    {
        ...
        public string EntityNamespace { get; set; } = "Entitys";
        ...
        public ushort ClassCapsCount { get; set; } = 0;

        /// <summary>
        /// 属性名称开头大写个数
        /// </summary>
        [JsonProperty(PropertyName = "propCapsCount")]
        public ushort PropCapsCount { get; set; } = 0;

        /// <summary>
        /// string类型是否去空格
        /// </summary>
        [JsonProperty(PropertyName = "propTrim")]
        public bool PropTrim { get; set; } = false;

        /// <summary>
        /// 值类型默认值
        /// </summary>
        [JsonProperty(PropertyName = "propDefault")]
        public bool PropDefault { get; set; } = false;

        /// <summary>
        /// 是否标识主键
        /// </summary>
        [JsonProperty(PropertyName = "sqlSugarPK")]
        public bool SqlSugarPK { get; set; } = false;

        /// <summary>
        /// 是否标识自增列
        /// </summary>
        [JsonProperty(PropertyName = "sqlSugarBZL")]
        public bool SqlSugarBZL { get; set; } = false;

        /// <summary>
        /// get自定义格式
        /// </summary>
        [JsonProperty(PropertyName = "getCus")]
        public string GetCus { get; set; } = "return this._属性";

        /// <summary>
        /// set自定义格式
        /// </summary>
        [JsonProperty(PropertyName = "setCus")]
        public string SetCus { get; set; } = "this._属性 = -value-";
        ...
        public PropType PropType { get; set; } = PropType.Easy;
    }
